...
class Test_005_Search_CustomerbyName:
    ...
    def test_searchcustomerbyname(self, Setup):
        self.logger.info("********************** Test_004_Search_CustomerbyName  ************************")
        ...
        for r in range(2, self.rows_customer + 1):
            ...
            searchcust.EnterFirstname(self.firstname)
            searchcust.EnterLastname(self.lastname)
